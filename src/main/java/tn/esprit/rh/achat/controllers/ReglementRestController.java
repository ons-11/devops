...
public class ReglementRestController {
  ...
  //localhost:8089/SpringMVC/reglement/add-reglement
    ...
    public List<Reglement> getReglement() {
     ...
     //localhost:8089/SpringMVC/reglement/retrieve-reglement/8
    ...
    //localhost:8089/SpringMVC/reglement/retrieveReglementByFacture/8
   ...
   //localhost:8089/SpringMVC/reglement/getChiffreAffaireEntreDeuxDate/{startDate}/{endDate}
